    ...
    <div>
      ...
      <div className='w-full flex justify-start items-center mx-auto max-w-4xl px-8 my-20'>
        <div className='flex gap-10 items-center'>
          ...
          <span onClick={() => navigate("/projects")} className='cursor-pointer duration-300 hover:text-altindigo'>projelerim</span>
          <span onClick={() => navigate("/blog")} className='cursor-pointer duration-300 hover:text-altindigo'>blog</span>
          <span onClick={() => navigate("/contact")} className='cursor-pointer duration-300 hover:text-altindigo'>iletişim</span>
          <div>
